(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_891726ba._.js", {
            ...
            const processCheckout = {
                "PaddleCheckoutHandler.useEffect.processCheckout": async ()=>{
                    ...
                    try {
                        ...
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(checkoutRef, checkoutData);
...
function Dashboard() {
    ...
    const [checkoutComplete, setCheckoutComplete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handlePaddleEvent = async (event)=>{
        ...
        const subscriptionInfo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$paddle$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractSubscriptionInfo"])(event);
        ...
        try {
            ...
            if (event.name === 'checkout.completed') {
                ...
                const checkoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'users', user.uid, 'checkouts');
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])(checkoutRef, checkoutData);
                console.log('Checkout data saved to Firebase');
                ...
                if (subscriptionInfo.customerId) {
                    const serverSubscription = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$paddle$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncSubscriptionWithServer"])(subscriptionInfo.customerId, user.uid);
    ...
    const fetchTransactionLogs = async (userId)=>{
        try {
            ...
            const logs = transactionsSnap.docs.map((doc)=>({
                    id: doc.id,
                    ...doc.data(),
                    planDetails: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$paddle$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identifyPlan"])(doc.data().product.id)
                }));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            checkoutComplete && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Dashboard, "jFdAC65ehEeNWk4MeKxYjmtVyls=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_891726ba._.js.map