...
"[project]/.next-internal/server/app/api/subscriptions/get-details/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/subscriptions/get-details/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const snapshot = await transactionsRef.where('customerId', '==', customerId).orderBy('createdAt', 'desc').limit(1).get();
        if (snapshot.empty) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d8cf818d._.js.map